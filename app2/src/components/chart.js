...
function Chart({count}) {
    ...
    series: [
      {
        ...
        data: [
          ...
          6.8, 4.4, 4.0, 3.8, 5.0, 4.9, 9.2, 9.6, 9.5, 6.3, 9.5, 10.8, 14.0,
          11.5, 10.0, 10.2, 10.3, 9.4, 8.9, 10.6, 10.5, 11.1, 10.4, 10.7, 11.3,
          10.2, 9.6, 10.2, 11.1, 10.8, 13.0, 12.5, 12.5, 11.3, 10.1,
        ],
      },
      {
        name: "Vik",
  ...
  return (
    <div>
      ...
      <button className="btn btn-success" onClick={() => increment(count + 1)}>increment</button>
    </div>
  );
}
